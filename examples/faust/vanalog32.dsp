...
masterVol = hslider("masterVol [slider:8]",0.125,0,1,0.01) <: _*_;
...
main = os.oscrc(440)* 0.25 * killSwitch * os.sawtooth(oscFreq) + no.noise*noiseGain*activateNoise : fi.resonlp(LFO*lfoRange+50,5,1) * masterVol <: _*(1-panning),_*panning;
process = main <: par(i, 32, _);
