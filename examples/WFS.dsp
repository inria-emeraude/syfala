...
with {
    x(p) = hslider("v: Source %p/x coordinate of source %p",SD*NC/2,0,SD*NC,0.01) : si.smoo;
    y(p) = hslider("v: Source %p/y coordinate of source %p",10,1,20,0.01) : si.smoo;
};
...
process = sourcesArray(nSpeakers,speakersDist,_);
