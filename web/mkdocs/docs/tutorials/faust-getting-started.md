...
1. The **embedded Linux** for syfala ([doc/tutorials/linux/getting-started.md](embedded-linux-getting-started.md))
...
For the rest of the procedure, you can follow the [syfala-linux getting-started tutorial](embedded-linux-getting-started.md)
