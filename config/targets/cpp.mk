...
HLS_FLAGS_INCLUDE   ?= "-I$(BUILD_INCLUDE_DIR) -I$(dir $(HLS_SOURCE_MAIN))"

get_nchannels_i     ?= $(call parse_define,INPUTS)
get_nchannels_o     ?= $(call parse_define,OUTPUTS)
get_ncontrols_i     ?= $(call parse_define,FAUST_INT_CONTROLS)
get_ncontrols_f     ?= $(call parse_define,FAUST_REAL_CONTROLS)
get_ncontrols_p     ?= $(call parse_define,FAUST_PASSIVES)
get_mem_f           ?= $(call parse_define,FAUST_FLOAT_ZONE)
get_mem_i           ?= $(call parse_define,FAUST_INT_ZONE)
