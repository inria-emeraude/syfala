...
#OLD: FILE_CHECKED_PROJECT_VALID="$project_directory/build/hw_export/main_wrapper.xsa"
FILE_CHECKED_PROJECT_VALID="$project_directory/build/syfala_project/syfala_project.runs/impl_1/main_wrapper.bit"
