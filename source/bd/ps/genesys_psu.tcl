  ...
  set zynq_ultra_ps_e_0 [ create_bd_cell -type ip -vlnv $zynq_ultra_ps zynq_ultra_ps_e_0 ]
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_SIGNALS {sclk_out#miso_mo1#mo2#mo3#mosi_mi0#n_ss_out#clk_for_lpbk############rxd#txd##########################################################} \
