...
proc create_root_design { parentCell } {
  ...
  # Create ports
    ...
    set IIC_1_sda_io [ create_bd_port -dir O -from 0 -to 0 IIC_1_sda_io ]
    set external_codec_mclk [ create_bd_port -dir O external_codec_mclk ]
    set IIC_1_scl_io [ create_bd_port -dir O -from 0 -to 0 IIC_1_scl_io ]
    ...
    set CODEC6_sd_tx [ create_bd_port -dir O -from 0 -to 0 CODEC6_sd_tx ]
  ...
  connect_bd_intf_net -intf_net syfala_$m_axi_ram [get_bd_intf_pins axi_mem_interconn/S00_AXI] [get_bd_intf_pins syfala/$m_axi_ram]

  # Create port connections
  connect_bd_net -net GND_dout [get_bd_ports IIC_1_sda_io] [get_bd_ports IIC_1_scl_io] [get_bd_ports CODEC1_sd_tx] [get_bd_ports GND] [get_bd_ports CODEC6_sd_tx] [get_bd_ports CODEC2_sd_tx] [get_bd_pins GND/dout]
  ...
  connect_bd_net -net i2s_transceiver_tdm_0_l_data_rx [get_bd_pins i2s_transceiver_tdm_0/l_data_rx] [get_bd_pins syfala/in_ch0_V]
  connect_bd_net -net i2s_transceiver_tdm_0_r_data_rx [get_bd_pins i2s_transceiver_tdm_0/r_data_rx] [get_bd_pins syfala/in_ch1_V]
  connect_bd_net -net i2s_transceiver_tdm_0_sd_tx_0 [get_bd_ports CODEC1_sd_rx] [get_bd_pins i2s_transceiver_tdm_0/sd_tx_0]
  connect_bd_net -net i2s_transceiver_tdm_0_sd_tx_1 [get_bd_ports external_codec_bclk] [get_bd_pins i2s_transceiver_tdm_0/sd_tx_1]
  connect_bd_net -net i2s_transceiver_tdm_0_sd_tx_2 [get_bd_ports external_codec_mclk] [get_bd_pins i2s_transceiver_tdm_0/sd_tx_2]
  connect_bd_net -net i2s_transceiver_tdm_0_sd_tx_3 [get_bd_ports external_codec_ws] [get_bd_pins i2s_transceiver_tdm_0/sd_tx_3]
  ...
  connect_bd_net -net i2s_transceiver_tdm_0_tdm_ws [get_bd_ports CODEC6_sd_rx] [get_bd_pins i2s_transceiver_tdm_0/tdm_ws]
  ...
  connect_bd_net -net syfala_out_ch0_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_0] [get_bd_pins syfala/out_ch0_V]
  connect_bd_net -net syfala_out_ch0_V_ap_vld [get_bd_ports syfala_out_debug1] [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_0] [get_bd_pins syfala/out_ch0_V_ap_vld]
  connect_bd_net -net syfala_out_ch10_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_10] [get_bd_pins syfala/out_ch10_V]
  connect_bd_net -net syfala_out_ch10_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_10] [get_bd_pins syfala/out_ch10_V_ap_vld]
  connect_bd_net -net syfala_out_ch11_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_11] [get_bd_pins syfala/out_ch11_V]
  connect_bd_net -net syfala_out_ch11_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_11] [get_bd_pins syfala/out_ch11_V_ap_vld]
  connect_bd_net -net syfala_out_ch12_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_12] [get_bd_pins syfala/out_ch12_V]
  connect_bd_net -net syfala_out_ch12_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_12] [get_bd_pins syfala/out_ch12_V_ap_vld]
  connect_bd_net -net syfala_out_ch13_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_13] [get_bd_pins syfala/out_ch13_V]
  connect_bd_net -net syfala_out_ch13_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_13] [get_bd_pins syfala/out_ch13_V_ap_vld]
  connect_bd_net -net syfala_out_ch14_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_14] [get_bd_pins syfala/out_ch14_V]
  connect_bd_net -net syfala_out_ch14_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_14] [get_bd_pins syfala/out_ch14_V_ap_vld]
  connect_bd_net -net syfala_out_ch15_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_15] [get_bd_pins syfala/out_ch15_V]
  connect_bd_net -net syfala_out_ch15_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_15] [get_bd_pins syfala/out_ch15_V_ap_vld]
  connect_bd_net -net syfala_out_ch16_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_16] [get_bd_pins syfala/out_ch16_V]
  connect_bd_net -net syfala_out_ch16_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_16] [get_bd_pins syfala/out_ch16_V_ap_vld]
  connect_bd_net -net syfala_out_ch17_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_17] [get_bd_pins syfala/out_ch17_V]
  connect_bd_net -net syfala_out_ch17_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_17] [get_bd_pins syfala/out_ch17_V_ap_vld]
  connect_bd_net -net syfala_out_ch18_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_18] [get_bd_pins syfala/out_ch18_V]
  connect_bd_net -net syfala_out_ch18_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_18] [get_bd_pins syfala/out_ch18_V_ap_vld]
  connect_bd_net -net syfala_out_ch19_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_19] [get_bd_pins syfala/out_ch19_V]
  connect_bd_net -net syfala_out_ch19_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_19] [get_bd_pins syfala/out_ch19_V_ap_vld]
  connect_bd_net -net syfala_out_ch1_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_1] [get_bd_pins syfala/out_ch1_V]
  connect_bd_net -net syfala_out_ch1_V_ap_vld [get_bd_ports syfala_out_debug2] [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_1] [get_bd_pins syfala/out_ch1_V_ap_vld]
  connect_bd_net -net syfala_out_ch20_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_20] [get_bd_pins syfala/out_ch20_V]
  connect_bd_net -net syfala_out_ch20_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_20] [get_bd_pins syfala/out_ch20_V_ap_vld]
  connect_bd_net -net syfala_out_ch21_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_21] [get_bd_pins syfala/out_ch21_V]
  connect_bd_net -net syfala_out_ch21_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_21] [get_bd_pins syfala/out_ch21_V_ap_vld]
  connect_bd_net -net syfala_out_ch22_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_22] [get_bd_pins syfala/out_ch22_V]
  connect_bd_net -net syfala_out_ch22_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_22] [get_bd_pins syfala/out_ch22_V_ap_vld]
  connect_bd_net -net syfala_out_ch23_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_23] [get_bd_pins syfala/out_ch23_V]
  connect_bd_net -net syfala_out_ch23_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_23] [get_bd_pins syfala/out_ch23_V_ap_vld]
  connect_bd_net -net syfala_out_ch24_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_24] [get_bd_pins syfala/out_ch24_V]
  connect_bd_net -net syfala_out_ch24_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_24] [get_bd_pins syfala/out_ch24_V_ap_vld]
  connect_bd_net -net syfala_out_ch25_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_25] [get_bd_pins syfala/out_ch25_V]
  connect_bd_net -net syfala_out_ch25_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_25] [get_bd_pins syfala/out_ch25_V_ap_vld]
  connect_bd_net -net syfala_out_ch26_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_26] [get_bd_pins syfala/out_ch26_V]
  connect_bd_net -net syfala_out_ch26_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_26] [get_bd_pins syfala/out_ch26_V_ap_vld]
  connect_bd_net -net syfala_out_ch27_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_27] [get_bd_pins syfala/out_ch27_V]
  connect_bd_net -net syfala_out_ch27_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_27] [get_bd_pins syfala/out_ch27_V_ap_vld]
  connect_bd_net -net syfala_out_ch28_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_28] [get_bd_pins syfala/out_ch28_V]
  connect_bd_net -net syfala_out_ch28_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_28] [get_bd_pins syfala/out_ch28_V_ap_vld]
  connect_bd_net -net syfala_out_ch29_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_29] [get_bd_pins syfala/out_ch29_V]
  connect_bd_net -net syfala_out_ch29_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_29] [get_bd_pins syfala/out_ch29_V_ap_vld]
  connect_bd_net -net syfala_out_ch2_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_2] [get_bd_pins syfala/out_ch2_V]
  connect_bd_net -net syfala_out_ch2_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_2] [get_bd_pins syfala/out_ch2_V_ap_vld]
  connect_bd_net -net syfala_out_ch30_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_30] [get_bd_pins syfala/out_ch30_V]
  connect_bd_net -net syfala_out_ch30_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_30] [get_bd_pins syfala/out_ch30_V_ap_vld]
  connect_bd_net -net syfala_out_ch31_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_31] [get_bd_pins syfala/out_ch31_V]
  connect_bd_net -net syfala_out_ch31_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_31] [get_bd_pins syfala/out_ch31_V_ap_vld]
  connect_bd_net -net syfala_out_ch3_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_3] [get_bd_pins syfala/out_ch3_V]
  connect_bd_net -net syfala_out_ch3_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_3] [get_bd_pins syfala/out_ch3_V_ap_vld]
  connect_bd_net -net syfala_out_ch4_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_4] [get_bd_pins syfala/out_ch4_V]
  connect_bd_net -net syfala_out_ch4_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_4] [get_bd_pins syfala/out_ch4_V_ap_vld]
  connect_bd_net -net syfala_out_ch5_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_5] [get_bd_pins syfala/out_ch5_V]
  connect_bd_net -net syfala_out_ch5_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_5] [get_bd_pins syfala/out_ch5_V_ap_vld]
  connect_bd_net -net syfala_out_ch6_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_6] [get_bd_pins syfala/out_ch6_V]
  connect_bd_net -net syfala_out_ch6_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_6] [get_bd_pins syfala/out_ch6_V_ap_vld]
  connect_bd_net -net syfala_out_ch7_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_7] [get_bd_pins syfala/out_ch7_V]
  connect_bd_net -net syfala_out_ch7_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_7] [get_bd_pins syfala/out_ch7_V_ap_vld]
  connect_bd_net -net syfala_out_ch8_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_8] [get_bd_pins syfala/out_ch8_V]
  connect_bd_net -net syfala_out_ch8_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_8] [get_bd_pins syfala/out_ch8_V_ap_vld]
  connect_bd_net -net syfala_out_ch9_V [get_bd_pins i2s_transceiver_tdm_0/data_tx_9] [get_bd_pins syfala/out_ch9_V]
  connect_bd_net -net syfala_out_ch9_V_ap_vld [get_bd_pins i2s_transceiver_tdm_0/V_ap_vld_9] [get_bd_pins syfala/out_ch9_V_ap_vld]
  ...
  assign_bd_address -offset 0x00000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces syfala/Data_$m_axi_ram] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
