...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_wiz_I2S_clk_24Mhz [get_bd_ports internal_codec_mclk] [get_bd_ports syfala_out_debug3] [get_bd_pins clk_wiz_sys_clk/samp_clk] [get_bd_pins rst_global/slowest_sync_clk] [get_bd_pins syfala/ap_start]
  connect_bd_net -net clk_wiz_sys_clk_locked [get_bd_pins clk_wiz_sys_clk/locked] [get_bd_pins rst_global/dcm_locked]
  connect_bd_net -net clk_wiz_sys_clk_sys_clk [get_bd_pins axi_gpio_LED/s_axi_aclk] [get_bd_pins axi_gpio_SW/s_axi_aclk] [get_bd_pins axi_mem_interconn/ACLK] [get_bd_pins axi_mem_interconn/M00_ACLK] [get_bd_pins axi_mem_interconn/S00_ACLK] [get_bd_pins axi_periph_interconn/ACLK] [get_bd_pins axi_periph_interconn/M00_ACLK] [get_bd_pins axi_periph_interconn/M01_ACLK] [get_bd_pins axi_periph_interconn/M02_ACLK] [get_bd_pins axi_periph_interconn/S00_ACLK] [get_bd_pins clk_wiz_sys_clk/sys_clk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins sd_dac_first_0/sys_clk] [get_bd_pins syfala/ap_clk]
  connect_bd_net -net debug_btn_1 [get_bd_ports debug_btn] [get_bd_pins syfala/debugBtn]
  ...
  connect_bd_net -net sd_dac_first_0_output [get_bd_ports CODEC1_sd_rx] [get_bd_pins sd_dac_first_0/output]
