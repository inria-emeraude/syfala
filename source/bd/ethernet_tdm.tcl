...
proc create_root_design { parentCell } {
  ...
  set tdm_sclk [ create_bd_port -dir O tdm_sclk ]
  set tdm_sclk_GND [ create_bd_port -dir O tdm_sclk_GND ]
  set tdm_tx_0 [ create_bd_port -dir O tdm_tx_0 ]
  set tdm_tx_0_GND [ create_bd_port -dir O tdm_tx_0_GND ]
  set tdm_tx_1 [ create_bd_port -dir O tdm_tx_1 ]
  set tdm_tx_1_GND [ create_bd_port -dir O tdm_tx_1_GND ]
  set tdm_tx_2 [ create_bd_port -dir O tdm_tx_2 ]
  set tdm_tx_2_GND [ create_bd_port -dir O tdm_tx_2_GND ]
  set tdm_tx_3 [ create_bd_port -dir O tdm_tx_3 ]
  set tdm_tx_3_GND [ create_bd_port -dir O tdm_tx_3_GND ]
  set tdm_ws [ create_bd_port -dir O tdm_ws ]
  set tdm_ws_GND [ create_bd_port -dir O tdm_ws_GND ]
...
if $::rt::nchannels_i {
# --------------------------------------------------
connect "ports" internal_codec_sd_rx                \
        "pins" i2s_transceiver_0/ssm_sd_ch0_ch1_rx
# --------------------------------------------------
}
...
# Channel-dependent
# ---------------------------------------------------
for {set i 0} {$i < $::rt::nchannels_o} {incr i 8}  {
# ---------------------------------------------------
set n [expr $i/8]
# ---------------------------------------------------
...
# ---------------------------------------------------
  ...
  connect_bd_net -net mux_2to1_0_outMux [get_bd_pins mux_2to1_0/outMux]
  ...
  connect_bd_net -net syfala_ap_done [get_bd_pins syfala/ap_done]
