...
set leds_4bits  [add_intf_port "xilinx.com:interface:gpio_rtl:1.0" leds_4bits]
set rgb_led     [add_intf_port "xilinx.com:interface:gpio_rtl:1.0" rgb_led]
}
# -----------------------------------------------------------------------------
GENESYS {
# -----------------------------------------------------------------------------
...
set led_4bits     [add_intf_port "xilinx.com:interface:gpio_rtl:1.0" led_4bits]
set rgbled_3bits  [add_intf_port "xilinx.com:interface:gpio_rtl:1.0" rgbled_3bits]
}
}
# -----------------------------------------------------------------------------
# Common ports
...
GENESYS {
# -----------------------------------------------------------------------------
connect "intf_ports" rgbled_3bits        "intf_pins" axi_gpio_LED/GPIO2
connect "intf_ports" led_4bits           "intf_pins" axi_gpio_LED/GPIO
}
}
