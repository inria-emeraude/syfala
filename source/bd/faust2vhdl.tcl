...
# FAUST IP
# -----------------------------------------------------------------------------
set faust [create_bd_cell -type "module" -reference "mydsp" mydsp_0]
...
# ---------------------------------------------------
connect "pins" mydsp_0/audio_out_$n                  \
        "pins" i2s_transceiver_0/from_faust_ch$n
# ---------------------------------------------------
connect "pins" mydsp_0/audio_out_ap_vld_$n           \
...
#        "pins"  syfala/debug
# ---------------------------------------------------
connect "pins" mydsp_0/ap_done                      \
        "pins" i2s_transceiver_0/ap_done
# ---------------------------------------------------
connect "pins" mydsp_0/ap_start                     \
        "pins" i2s_transceiver_0/rdy
# ---------------------------------------------------
connect "pins" mydsp_0/bypass_dsp                   \
        "pins" sw0/Dout
# ---------------------------------------------------
connect "pins" mydsp_0/bypass_faust                 \
        "pins" sw1/Dout
# ---------------------------------------------------
...
connect "pins" mydsp_0/ap_rst_n            "pins" rst_global/peripheral_aresetn
...
connect "pins" $system_clock "pins" mydsp_0/ap_clk
