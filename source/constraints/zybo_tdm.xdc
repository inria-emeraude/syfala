...
##Pmod Header JD 3.3V
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33              } [get_ports  { tdm_tx_0 }];
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33              } [get_ports  { tdm_tx_0_GND }];
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33              } [get_ports  { tdm_tx_1 }];
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 PULLUP true  } [get_ports  { tdm_tx_1_GND }];
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33              } [get_ports  { tdm_tx_2 }];
set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVCMOS33 PULLUP true  } [get_ports  { tdm_tx_2_GND }];
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33              } [get_ports  { tdm_tx_3 }];
set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33              } [get_ports  { tdm_tx_3_GND }];

##Pmod Header JC 3.3V
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33     } [get_ports { tdm_sclk }];
set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33     } [get_ports { tdm_sclk_GND }];
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33     } [get_ports { tdm_ws }];
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33     } [get_ports { tdm_ws_GND }];
