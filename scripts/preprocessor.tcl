...
proc run_hls_preprocessor {f nchannels_i nchannels_o ncontrols_f ncontrols_i ncontrols_p mem_i mem_f multisample eth_no_output} {
    namespace eval rt {
...
switch $target {
    --hls {
        ...
        set eth_no_output   [lindex $::argv 10]
